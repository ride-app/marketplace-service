...
func (service *MarketplaceServiceServer) StartTrip(ctx context.Context,
	req *connect.Request[pb.StartTripRequest],
) (*connect.Response[pb.StartTripResponse], error) {
	...
	res := connect.NewResponse(&pb.StartTripResponse{})
