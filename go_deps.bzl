...
def go_dependencies():
    go_repository(
        ...
        sum = "h1:I5TCN8ojvCDSJdA0EROD332jhPoQbRf6evNZL7Mpgvc=",
        version = "v1.15.0-20230914171853-63dfe56cc2c4.1",
    )
    go_repository(
        ...
        sum = "h1:rOe/itdO7+9cWOnKqvpn1K7VmTDwp3vI4juPz6aNQbc=",
        version = "v1.32.0-20240212200630-3014d81c3a48.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Rvp/xwrTWaNDo78ejrOKket7mKWrNMJvs+5CK5NAHuc=",
        version = "v1.32.0-20231130202533-71881f09a0c5.1",
    )
    go_repository(
        ...
        version = "v1.15.0-20240127091614-32d65fcb4c5c.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:bkJscQRSRGZ8P9Lo08rOuMDLKacnIy1rDe3w53pIQLQ=",
        version = "v1.15.0-20240130062128-31fdce7a3669.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MPNZd6F2ekGWjWVQDv8lEYOX8ndSOzMnmTaGbDZWIcg=",
        version = "v0.5.2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_ride_app_driver_service",
        importpath = "github.com/ride-app/driver-service",
        sum = "h1:tzVGvpMRTqUbyy+vHzPEaT/qKA7DN+mRE90PWuFCrk0=",
        version = "v0.0.0-20240218051850-1bf2f23c83aa",
    )
    go_repository(
